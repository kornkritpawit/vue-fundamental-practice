{
  mode: 'production',
  context: 'D:\\korn\\learn\\vuejs-fundamentals\\build-a-bot-korn',
  devtool: 'source-map',
  output: {
    hashFunction: 'xxhash64',
    path: 'D:\\korn\\learn\\vuejs-fundamentals\\build-a-bot-korn\\dist',
  ...
  resolve: {
    alias: {
      '@': 'D:\\korn\\learn\\vuejs-fundamentals\\build-a-bot-korn\\src',
    ...
    modules: [
      'node_modules',
      'D:\\korn\\learn\\vuejs-fundamentals\\build-a-bot-korn\\node_modules',
    ...
    rules: [
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'D:\\korn\\learn\\vuejs-fundamentals\\build-a-bot-korn\\node_modules\\vue-loader\\dist\\index.js',
            options: {
              cacheDirectory: 'D:\\korn\\learn\\vuejs-fundamentals\\build-a-bot-korn\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '74b13c8f',
              babelParserPlugins: [
                'jsx',
                'classProperties',
                'decorators-legacy'
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        title: 'build-a-bot-korn',
        scriptLoading: 'defer',
        templateParameters: function () { /* omitted long function */ },
        template: 'D:\\korn\\learn\\vuejs-fundamentals\\build-a-bot-korn\\public\\index.html'
      }
    ),
    /* config.plugin('copy') */
    new CopyPlugin(
      {
        patterns: [
          {
            from: 'D:\\korn\\learn\\vuejs-fundamentals\\build-a-bot-korn\\public',
            to: 'D:\\korn\\learn\\vuejs-fundamentals\\build-a-bot-korn\\dist',
            toType: 'dir',
            noErrorOnMissing: true,
            globOptions: {
              ignore: [
                '**/.DS_Store',
                'D:/korn/learn/vuejs-fundamentals/build-a-bot-korn/public/index.html'
              ]
            },
            info: {
              minimized: true
